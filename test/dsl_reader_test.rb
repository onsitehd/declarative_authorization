...
class DSLReaderTest < Test::Unit::TestCase
  def test_privileges
    ...
    assert_equal [[:lower_priv, nil]], reader.privileges_reader.privilege_hierarchy[:test_priv]
  end
  ...
  def test_privileges_with_context
    ...
    assert_equal [[:lower_priv, :test_context]], reader.privileges_reader.privilege_hierarchy[:test_priv]
  end
  ...
  def test_privileges_one_line
    ...
    assert_equal [[:lower_priv, :test_context]], reader.privileges_reader.privilege_hierarchy[:test_priv]
    assert_equal [[:lower_priv, :test_context]], reader.privileges_reader.privilege_hierarchy[:test_priv_2]
    assert_equal [[:lower_priv, nil]], reader.privileges_reader.privilege_hierarchy[:test_priv_3]
  end
