...
class ChangeAnalyzerTest < Test::Unit::TestCase
  ...
  def test_adding_permission
    ...
    approaches = analyzer.find_approaches_for(:add, :permission, :on => :permissions, :to => :read, :users => [user_to_extend_permissions, another_user]) do
  ...
  def test_adding_permission_with_new_role_complex
    ...
    approaches = analyzer.find_approaches_for(:add, :permission, :on => :permissions, :to => :read, :users => [another_user, user_to_extend_permissions]) do
      assert permit?(:read, :context => :permissions, :user => users[1])
  ...
  def test_removing_permission
    ...
    approaches = analyzer.find_approaches_for(:remove, :permission, :on => :permissions, :to => :read, :users => [user_to_remove_permissions_from]) do
      assert !permit?(:read, :context => :permissions, :user => users.first)
    end
  ...
  def test_moving_permission
    ...
    approaches = analyzer.find_approaches_for(:remove, :permission, :on => :permissions, :to => :read, :users => [user_to_remove_permissions_from, user_to_keep_permission]) do
      assert !permit?(:read, :context => :permissions, :user => users.first)
      assert permit?(:read, :context => :permissions, :user => users[1])
    end
