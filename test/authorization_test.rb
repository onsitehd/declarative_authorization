...
class AuthorizationTest < Test::Unit::TestCase
  def test_permit
    ...
    assert engine.permit?(:test, :context => :permissions, :user => MockUser.new(:test_role, :test_role_2))
    refute engine.permit?(:test_2, :context => :permissions_2, :user => MockUser.new(:test_role))
    refute engine.permit?(:test, :context => :permissions, :user => MockUser.new(:test_role_2))
  end
  ...
  def test_permit_context_people
    ...
    engine = Authorization::Engine.new(reader)
    assert engine.permit?(:test, :context => :people, :user => MockUser.new(:test_role))
  end
  ...
  def test_permit_with_has_omnipotence
    ...
    engine = Authorization::Engine.new(reader)
    assert engine.permit?(:test, :context => :people, :user => MockUser.new(:admin))
  end
  ...
  def test_permit_multiple_contexts
    ...
    assert engine.permit?(:test, :context => :permissions_2, :user => MockUser.new(:test_role))
    refute engine.permit?(:test, :context => :permissions_3, :user => MockUser.new(:test_role))
  ...
  def test_permit_with_frozen_roles
    ...
    assert_nothing_raised do
      assert engine.permit?(:test, :context => :permissions, :user => MockUser.new(:role_symbols => roles))
    end
  end
  ...
  def test_obligations_without_conditions
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal [{}], engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role))
  end
  ...
  def test_obligations_with_conditions
    ...
    assert_equal(
      [{ :attr => [:is, 1] }],
      engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role, :attr => 1))
    )
  end
  ...
  def test_obligations_with_omnipotence
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal [], engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role, :admin, :attr => 1))
  end
  ...
  def test_obligations_with_anded_conditions
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal(
      [{ :attr => [:is, 1], :attr_2 => [:is, 2] }],
      engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role, :attr => 1, :attr_2 => 2))
    )
  end
  ...
  def test_obligations_with_deep_anded_conditions
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal(
      [{ :attr => { :deeper_attr => [:is, 1], :deeper_attr_2 => [:is, 2] } }],
      engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role, :deeper_attr => 1, :deeper_attr_2 => 2))
    )
  end
  ...
  def test_obligations_with_has_many
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal(
      [{ :attrs => { :deeper_attr => [:is, 1] } }],
      engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role, :deeper_attr => 1))
    )
  end
  ...
  def test_obligations_with_permissions
      ...
      authorization do
        role :test_role do
          ...
          has_permission_on :permission_children_children, :to => :test do
            if_permitted_to :test, :permission_child => :permission, :context => :permissions
          end
        end
      end
    )
    engine = Authorization::Engine.new(reader)
    assert_equal(
      [{ :permission => { :attr => [:is, 1] } }],
      engine.obligations(:test, :context => :permission_children, :user => MockUser.new(:test_role, :attr => 1))
    )
    assert_equal(
      [{ :permission => { :attr => [:is, 1] } }],
      engine.obligations(:test, :context => :permission_children_2, :user => MockUser.new(:test_role, :attr => 1))
    )
    assert_equal(
      [{ :permission_child => { :permission => { :attr => [:is, 1] } } }],
      engine.obligations(:test, :context => :permission_children_children, :user => MockUser.new(:test_role, :attr => 1))
    )
  end
  ...
  def test_obligations_with_has_many_permissions
    ...
    reader.parse %(
      authorization do
        role :test_role do
          ...
          has_permission_on :permission_children_children, :to => :test do
            if_permitted_to :test, :permission_child => :permissions, :context => :permissions
          end
        end
      end
    )
    ...
    assert_equal(
      [{ :permission_child => { :permissions => { :attr => [:is, 1] } } }],
      engine.obligations(:test, :context => :permission_children_children, :user => MockUser.new(:test_role, :attr => 1))
    )
  end
  ...
  def test_obligations_with_permissions_multiple
    ...
    engine = Authorization::Engine.new(reader)
    assert_equal(
      [{ :permission_child => { :permission => { :attr => [:is, 1] } } }, { :permission_child => { :permission => { :attr => [:is, 2] } } }],
      engine.obligations(:test, :context => :permission_children_children, :user => MockUser.new(:test_role))
    )
  end
  ...
  def test_obligations_with_permissions_and_anded_conditions
    ...
    assert_equal(
      [{ :test_attr => [:is, 1], :permission => { :test_attr => [:is, 1] } }],
      engine.obligations(:test, :context => :permission_children, :user => MockUser.new(:test_role))
    )
  end
  ...
  def test_guest_user
    ...
    refute engine.permit?(:test, :context => :permissions_2)
  end
  ...
  def test_default_role
    ...
    engine = Authorization::Engine.new(reader)
    assert engine.permit?(:test, :context => :permissions)
    refute engine.permit?(:test, :context => :permissions, :user => MockUser.new(:guest))
  ...
  def test_privilege_hierarchy_without_context
    ...
    engine = Authorization::Engine.new(reader)
    assert engine.permit?(:list, :context => :permissions, :user => MockUser.new(:test_role))
  end
  ...
  def test_attribute_deep
    ...
    assert_equal(
      [{ :test_attr_1 => { :test_attr_2 => [:contains, 1] } }],
      engine.obligations(:test, :context => :permissions, :user => MockUser.new(:test_role))
    )
  end
  ...
  def test_attribute_with_deep_permissions
    ...
    assert engine.permit?(
      ...
      :object => MockDataObject.new(
        :shallow_permission => MockDataObject.new(:permission => perm_data_attr_1)
      )
    )
    refute engine.permit?(
      :test,
      ...
      :user => MockUser.new(:test_role),
      :object => MockDataObject.new(
        :shallow_permission => MockDataObject.new(:permission => perm_data_attr_2)
      )
    )
  end
  ...
  def test_attribute_with_deep_has_many_permissions
    ...
    assert engine.permit?(
      ...
      :user => MockUser.new(:test_role),
      :object => MockDataObject.new(
        :shallow_permissions => [MockDataObject.new(:permission => perm_data_attr_1)]
      )
    )
    refute engine.permit?(
      :test,
      ...
      :user => MockUser.new(:test_role),
      :object => MockDataObject.new(
        :shallow_permissions => [MockDataObject.new(:permission => perm_data_attr_2)]
      )
    )
  end
  ...
  def test_multithread
    ...
    Thread.new do
      ...
      refute engine.permit?(:test, :context => :permissions)
    end
  ...
  def test_clone
    ...
    assert_not_equal engine.auth_rules.first.contexts.object_id, cloned_engine.auth_rules.first.contexts.object_id
    refute_equal(
      engine.auth_rules.first.attributes.first.send(:instance_variable_get, :@conditions_hash)[:attr].object_id,
